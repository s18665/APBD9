...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task2()
        {
            var res = Emps.Where(x => x.Job == "Backend programmer" && x.Salary > 1000).OrderByDescending(emp => emp.Ename);
        }
        ...
        public void Task4()
        {
            var res = Emps.Where(x => x.Salary == Emps.Max(emp => emp.Salary));
        }
        ...
        public void Task7()
        {
            var res = Emps.Select(x => new {
                EmployeeJob = x.Job, 
                EmployeeNuber = Emps.Count(emp => emp.Job == x.Job)
            }).GroupBy(emp1 => emp1.EmployeeJob);
        }
        ...
        public void Task9()
        {
            var res = Emps.Where(x => x.Job == "Frontend programmer").OrderByDescending(emp => emp.HireDate).First();
        }
        ...
        public void Task10()
        {
            var res = Emps.Select(emp => new Emp() {
                Ename = emp.Ename,
                Job = emp.Job,
